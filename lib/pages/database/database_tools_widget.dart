...
import 'package:admin/utils/random_color_generator.dart';
...
class DatabaseToolsWidget extends StatefulWidget {
  @override
  _DatabaseToolsWidgetState createState() => _DatabaseToolsWidgetState();
}

class _DatabaseToolsWidgetState extends State<DatabaseToolsWidget> {
  int _selectedItem;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
          Text("Tools"),
          AppButton(
            child: Icon(_selectedItem == 1 ? Icons.close : Icons.location_on),
